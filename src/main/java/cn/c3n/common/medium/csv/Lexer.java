...
import static cn.c3n.common.medium.csv.Token.Type.*;
import static cn.c3n.common.medium.csv.Token.Type.COMMENT;
...
final class Lexer implements Closeable {
     ...
     *
     * @param token
     * @param needSetComment
     * @return
     * @throws IOException
     */
    Token nextToken(final Token token , boolean needSetComment) throws IOException{
        ...
        if (isStartOfLine(lastChar) && isCommentStart(c, needSetComment)) {
    ...
    Token nextToken(final Token token) throws IOException {
            return this.nextToken(token, false);
    }
    ...
    boolean isCommentStart(final int ch, boolean needSetComment) {
        return needSetComment? true: ch == commentStart;
    }
