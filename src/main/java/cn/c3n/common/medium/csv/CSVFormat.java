package cn.c3n.common.medium.csv;/*
...
import static cn.c3n.common.medium.csv.Constants.*;
...
public final class CSVFormat implements Serializable {
    ...
    public static final CSVFormat DEFAULT = new CSVFormat(COMMA, DOUBLE_QUOTE_CHAR, null, null, null, false, true, CRLF,
            null, null, null, null, false, "|_|", false, false, false, false, false);
    ...
    public static CSVFormat newFormat(final char delimiter) {
        return new CSVFormat(delimiter, null, null, null,
                null, false, false, null,
                null, null, null, null, false, "_", false, false,
                false, false, false);
    }
    ...
    private final List<Long> skipLineNumbers;// array of jump lines

    private final boolean allowSameName;// allow same name and auto name with splitter

    private final String  allowSameNameSplitter;//allow same name splitter char
...
//            final Object[] headerComments, final String[] header, final List<Long> skipLineNumbers, final boolean skipHeaderRecord,
...
//    }
    ...
    private CSVFormat(final char delimiter, final Character quoteChar, final QuoteMode quoteMode,
                      final Character commentStart, final Character escape, final boolean ignoreSurroundingSpaces,
                      final boolean ignoreEmptyLines, final String recordSeparator, final String nullString,
                      final Object[] headerComments, final String[] header, final List<Long> skipLineNumbers, final boolean allowSameName, final String allowSameNameSplitter,  final boolean skipHeaderRecord,
                      final boolean allowMissingColumnNames, final boolean ignoreHeaderCase, final boolean trim,
                      final boolean trailingDelimiter) {
        this.delimiter = delimiter;
        this.quoteCharacter = quoteChar;
        ...
        this.header = header == null ? null : header.clone();
        this.skipLineNumbers = skipLineNumbers;
        this.allowSameNameSplitter = allowSameNameSplitter;
    ...
    public List<Long> getSkipLineNumbers() {
        return skipLineNumbers != null ? skipLineNumbers : new ArrayList<Long>();
    }
    ...
    public String getAllowSameNameSplitter()
    {
        return allowSameNameSplitter != null ? allowSameNameSplitter : "";
    }
    ...
    public CSVFormat withAllowMissingColumnNames(final boolean allowMissingColumnNames) {
        return new CSVFormat(delimiter, quoteCharacter, quoteMode, commentMarker, escapeCharacter,
                ignoreSurroundingSpaces, ignoreEmptyLines, recordSeparator, nullString, headerComments, header,skipLineNumbers,allowSameName,allowSameNameSplitter,
    ...
    public CSVFormat withEscape(final Character escape) {
        ...
        return new CSVFormat(delimiter, quoteCharacter, quoteMode, commentMarker, escape, ignoreSurroundingSpaces,
                ignoreEmptyLines, recordSeparator, nullString, headerComments, header, skipLineNumbers,allowSameName,allowSameNameSplitter,skipHeaderRecord,
    ...
    public CSVFormat withSkipLines(final Long... skipLineNumbers){
        return new CSVFormat(delimiter, quoteCharacter, quoteMode, commentMarker, escapeCharacter,
                ignoreSurroundingSpaces, ignoreEmptyLines, recordSeparator, nullString, headerComments, header, Arrays.asList(skipLineNumbers),allowSameName,allowSameNameSplitter,
                skipHeaderRecord, allowMissingColumnNames, ignoreHeaderCase, trim, trailingDelimiter);
    }

    public CSVFormat withAllowSameName(final boolean allowSameName, final String allowSameNameSplitter)
    {
        return new CSVFormat(delimiter, quoteCharacter, quoteMode, commentMarker, escapeCharacter,
                ignoreSurroundingSpaces, ignoreEmptyLines, recordSeparator, nullString, headerComments, header, skipLineNumbers, allowSameName,allowSameNameSplitter,
                skipHeaderRecord, allowMissingColumnNames, ignoreHeaderCase, trim, trailingDelimiter);
